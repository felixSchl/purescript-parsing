...
parseFailedFatal :: forall s a. s -> Position -> String -> Result s a
parseFailedFatal = parseFailed' true

parseFailed' :: forall s a. Boolean -> s -> Position -> String -> Result s a
parseFailed' isFatal s pos msg = Result s (Left (ParseError msg pos isFatal)) false pos
